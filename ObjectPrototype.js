...
function Book(title, author, publicationYear) {
  ...
  // Add isClassic method to the prototype chain
  ...
  // Consoling output
  console.log(book1.isClassic()); // Output: The book is not a classic collection book
  console.log(book3.isClassic()); // Output: The book is from the classic collection

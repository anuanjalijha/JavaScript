...
const songs = [
  ...
  function filterSongs(songs,filters){
      const filteredGenre = songs.filter((song) => {
  return song.genre === filters.genre;
});

const filteredDuration = filteredGenre.filter((song) => {
  return song.duration > filters.duration;
});
